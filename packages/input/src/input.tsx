  ...
  ({ className, error, helpText, onBlur, ...props }, forwardedRef) => {
    ...
    function getVariantStyles(variant: IInputValidationStates) {
      switch (variant) {
        ...
        default:
        case "valid":
          return "text-gray-700 dark:text-gray-200 border-gray-300 dark:border-gray-700 focus:ring-blue-500/50 focus:dark:ring-blue-400/50 focus:border-blue-500 dark:focus:border-blue-400";
      }
    }
    ...
    return (
      <>
        <Component.input
          ...
          className={clsx(
            "flex w-full px-2 py-1 my-1 font-normal border rounded-md shadow-sm appearance-none text-small focus:outline-none focus:ring bg-gray-50 dark:bg-gray-800 placeholder:text-gray-400 placeholder:dark:text-gray-500 disabled:border-gray-300/50 disabled:dark:border-gray-700/50 disabled:cursor-not-allowed disabled:shadow-none disabled:bg-gray-50/50 dark:disabled:bg-gray-800/50 disabled:text-gray-700/50 disabled:dark:text-gray-200/50 read-only:border-gray-300/50 read-only:dark:border-gray-700/50 read-only:bg-gray-50/50 read-only:dark:bg-gray-800/50 read-only:shadow-none invalid:focus:bg-red-50 invalid:dark:focus:bg-red-500/10 invalid:text-red-600 invalid:dark:text-red-300 invalid:border-red-300 invalid:dark:border-red-700 invalid:focus:ring-red-500/50 invalid:focus:border-red-500",
