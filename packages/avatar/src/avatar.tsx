      ...
      <Component.span
        className={twx(
          ...
          getTheme(theme, {
            ...
            neutral:
              "bg-neutral-100 dark:bg-neutral-800 border-neutral-300 dark:border-neutral-400 text-neutral-500 dark:text-neutral-400",
            stone:
              "bg-stone-100 dark:bg-stone-800 border-stone-300 dark:border-stone-400 text-stone-500 dark:text-stone-400",
            red: "bg-red-100 dark:bg-red-900 border-red-300 dark:border-red-400 text-red-500 dark:text-red-300",
            orange:
              "bg-orange-100 dark:bg-orange-900 border-orange-300 dark:border-orange-400 text-orange-500 dark:text-orange-300",
            amber:
              "bg-amber-100 dark:bg-amber-900 border-amber-300 dark:border-amber-400 text-amber-500 dark:text-amber-300",
            yellow:
              "bg-yellow-100 dark:bg-yellow-900 border-yellow-300 dark:border-yellow-400 text-yellow-500 dark:text-yellow-300",
            lime: "bg-lime-100 dark:bg-lime-900 border-lime-300 dark:border-lime-400 text-lime-500 dark:text-lime-300",
            green:
              "bg-green-100 dark:bg-green-900 border-green-300 dark:border-green-400 text-green-500 dark:text-green-300",
            emerald:
              "bg-emerald-100 dark:bg-emerald-900 border-emerald-300 dark:border-emerald-400 text-emerald-500 dark:text-emerald-300",
            ...
            indigo:
              "bg-indigo-100 dark:bg-indigo-900 border-indigo-300 dark:border-indigo-400 text-indigo-500 dark:text-indigo-300",
            violet:
              "bg-violet-100 dark:bg-violet-900 border-violet-300 dark:border-violet-400 text-violet-500 dark:text-violet-300",
            purple:
              "bg-purple-100 dark:bg-purple-900 border-purple-300 dark:border-purple-400 text-purple-500 dark:text-purple-300",
            fuchsia:
              "bg-fuchsia-100 dark:bg-fuchsia-900 border-fuchsia-300 dark:border-fuchsia-400 text-fuchsia-500 dark:text-fuchsia-300",
